...
export const FUNNEL_PHASES: FunnelPhase[] = [
  ...
  },
  {
    ...
    ours: {
      ...
      copies: [
        ...
        { name: 'WhatsApp · priority list invite', src: 'adaptado de Ángel', text: "For those of you who show up live every Sunday: I am opening a small priority list.\nIt is a separate space from the main community. When we open the Academy, this list gets in first, at the best price, before anyone else.\nIf that is you, join here: [link]", why: 'Lista prioritaria de Ángel: durante el nurture separa a los más calientes (los que vienen en directo) en una lista aparte que entrará primero y con mejor precio, preparándolos para el cierre.' },
      ],
    },
  ...
  },
  {
    ...
    ours: {
      ...
      copies: [
        ...
        { name: 'WhatsApp · group filled, second one open', src: 'adaptado de Ángel', text: "The priority group just filled up. Honestly did not expect this.\nSo I opened a second one, join here: [link]\nIn a bit I will send a full no-fluff video of everything inside the Academy, so you have all the info before we open, with launch conditions that will not come back.\nIf you want in tomorrow at those conditions, I will see you inside.", why: 'Escasez REAL de Ángel ("se ha llenado el grupo, os dejo otro que he creado") encadenada con el vídeo "sin humo". Regla honesta: solo se anuncia si el grupo se ha llenado de verdad, nunca fingido.' },
      ],
    },
  ...
  },
  {
    ...
    ours: {
      ...
      copies: [
        { when: 'Vie 8 Ago · tarde', name: 'Priority list closes first', src: 'adaptado de Ángel', text: "Priority list, this is your head start.\nYou get into the Academy before the public doors even open, and at the locked launch price.\nThis window is only for you and it closes tomorrow at 17:00 CET, before the public doors close at 23:59.\nIf you have been with me these three Sundays, this is your moment. Your spot is here: [link]\nSee you inside.", why: 'Doble deadline al estilo Ángel: la lista prioritaria se cierra ANTES que el público (17:00 vs 23:59), premiando a los más calientes con acceso y precio primero. Honesto: dos ventanas reales, sin trucos.' },
        ...
        { when: 'Sáb 9 Ago · 20:00', name: 'Final hours · doors close 23:59', src: 'adaptado de Celia', text: "Final hours.\nAt 23:59 CET tonight the doors to the Academy close and the launch price is gone. No countdown tricks, that is the real line.\nEverything you saw across the three lives is inside: the community, the weekly live rooms, and the prompt packs I use every week.\nThis is your last window to walk in at the launch price: [link]", why: 'Escasez creciente con hora exacta (23:59) tomada de la secuencia del día de cierre de Celia, pero SIN su dark pattern del "error técnico": el deadline es real y se dice claro, anclando la decisión a una hora concreta.' },
        ...
        { when: 'Sáb 9 Ago · 23:50', name: 'Mission close · with me or without me', src: 'adaptado de Ángel', text: "Last call. In a few minutes, at 23:59 CET, the doors close.\nThank you to everyone who walked in this week. It means everything to me.\nAnd to everyone still reading: with me or without me, learn to make AI video that does not look like AI. This wave is not slowing down, and I do not want you watching it from the outside.\nIf you want to do it with me, this is the last moment: [link]", why: 'Cierre con misión, no de vendedor (Ángel: "conmigo o sin mí, formaos en IA sí o sí"): quita presión comercial, deja la responsabilidad en el lector y sube la gratitud, con deadline duro a las 23:59.' },
      ],
    },
  ...
  },
  {
    ...
    ours: {
      ...
      copies: [
        ...
        { when: 'Post-cierre · noche del cierre', name: 'Second-chance list (separate group)', src: 'adaptado de Ángel', text: "The doors are closed. But I know some of you were right on the edge and life got in the way.\nSo I opened one small separate list, apart from the main community. If you still want in, drop your name here and you will be the first to know the moment there is a way back in: [link]\nNo spam. One message, only when it matters.", why: 'Lista prioritaria SEPARADA del canal general (Ángel): recoge a los indecisos tras el cierre en un grupo aparte para reactivarlos primero cuando haya downsell o reapertura. Honesto: se dice claramente para qué es.' },
        { when: 'Post-cierre · día +1', name: 'No-fluff walkthrough of the Academy', src: 'adaptado de Ángel', text: "Before you decide, here is the full walkthrough, no fluff.\nI recorded a screen tour of everything inside the Academy: the course, the community, the weekly live rooms, and the prompt packs I actually use. No hype, no editing tricks, just what you get.\nWatch it, then decide with everything on the table: [link]", why: 'Vídeo "SIN HUMO" de Ángel: transparencia total (tour real de lo de dentro) antes del precio para desarmar la desconfianza del que no compró. En la web de cierre va arriba, junto al replay del directo.' },
        { when: 'Post-cierre · día +1', name: 'Feedback survey + raffle (1 month free)', src: 'adaptado de Ángel', text: "Quick favour, and there is a gift in it for you.\nYou have been in my free lives but have not joined yet, and your honest opinion matters to me. Tell me what you liked, what helped, and what was missing. Two minutes: [Tally link]\nEveryone who fills it in goes into a raffle for one month free inside the Academy. Answer today, I announce the winner tomorrow.", why: 'Encuesta Tally con sorteo (1 mes gratis) a NO-compradores, de Ángel: el sorteo sube la tasa de respuesta y la encuesta minea la objeción real (casi siempre el precio), que justifica el downsell siguiente.' },
        { when: 'Post-cierre · día +2', name: 'Second-chance window (honest deadline)', src: 'adaptado de Ángel', text: "You told me the price was the blocker. I heard you.\nSo here is a real second chance: for the next 6 hours you can still join at the launch price, $49 a month, before it goes to $500 to the public. Same Academy, same community, same weekly lives.\nThis window is real and it closes for good tonight at [time] CET. If it ever needs more time, I will tell you straight. No fake countdowns, ever: [link]", why: 'Downsell "me lo pedisteis" + segundo deadline corto de Ángel, pero HONESTO y con el producto real de Tudor: en vez de bajar a un plan pobre, reabrimos el precio de lanzamiento verdadero ($49/mes vs $500 público) con hora de cierre real. Si hay que ampliar, se anuncia claro (nunca el "error técnico" de Celia).' },
      ],
    },
