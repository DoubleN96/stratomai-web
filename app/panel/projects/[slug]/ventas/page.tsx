...
import { SetterCard, CloserCard } from '@/components/panel/intkapital/PersonCards';
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        {sales.ok && sales.data && (
          <p className="mb-8 text-xs text-[#5a6b94]">
            ...
            actualizado {new Date(sales.data.generatedAt).toLocaleString('es-ES')}
          </p>
        )}
        ...
        {!sales.ok || !sales.data ? (
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="mb-4 text-lg font-bold text-white">Resumen del equipo</h2>
              <OverviewSection overview={sales.data.overview} />
            </section>
            ...
            {/* Setters */}
            <section>
              <h2 className="mb-4 text-lg font-bold text-white">Setters</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {sales.data.setters.map((s) => (
                  <SetterCard key={s.ghlUserId} kpi={s} />
                ))}
              </div>
            </section>
            ...
            {/* Meta Ads */}
            <section>
              <h2 className="mb-4 text-lg font-bold text-white">Campañas Meta Ads</h2>
              {isAdmin && (
                <div className="mb-4">
            ...
            <section>
              ...
              <EmptyState>
                ...
                (objeciones, sentiment, próximos pasos) con Fathom. La API key ya
                está configurada (cifrada). Pendiente de implementar el job de
                ingesta + resumen.
              </EmptyState>
            </section>
          </div>
